...
jsonform.elementTypes = {
  ...
  'array': {
    'template': '<div id="<%= id %>"><ul class="_jsonform-array-ul" id="sortable-items" style="list-style-type:none;"><%= children %></ul>' +
    ...
    'childTemplate': function (inner) {
      // if ($('').sortable) {
        ...
        '<span class="draggable line"><i class="fas fa-list" title="Move item"></i></span> <a href="javascript:void(0);" onClick="removeItem(this)" class=""><i class="fas fa-times" title="Remove item"></i></a>'
           +
          inner +
          '</li>';
      // }
